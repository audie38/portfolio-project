...
const Navbar = () => {
  ...
  const setIsMobileMenuOpenHandler = () => {
    setIsMobileMenuOpen((prev) => !prev);
  };

  const setIsProfileMenuOpenHanldler = () => {
        ...
        <div className="relative flex h-20 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
            <button
              ...
              aria-expanded="false"
              onClick={setIsMobileMenuOpenHandler}
            >
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            <Link className="flex flex-shrink-0 items-center" href="/">
              ...
              <span className="hidden md:block text-white text-2xl font-bold ml-2">NextProperty</span>
            </Link>
              ...
              <div className="relative ml-3">
                <div>
                  <button
                    ...
                    aria-expanded="false"
                    aria-haspopup="true"
                    onClick={setIsProfileMenuOpenHanldler}
                  >
                    <span className="absolute -inset-1.5"></span>
